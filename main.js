...
var $author$project$Types$Adjoining = function (a) {
	return {$: 'Adjoining', a: a};
};
var $author$project$Monsters$Orcs$dhoman = {age: 31, description: '\n    Orc, wearing an eye-patch.\n    Hopes to one day sacrifice an elf to Gruumsh, and pluck out his own left eye to gain the god\'s favor.\n    He\'s getting old, so he wants to gain spellcasting ability so that he may find a way to live forever.\n    ', hitPoints: 19, name: 'Dhoman, Yet One-Eyed'};
var $author$project$Monsters$Orcs$ghog = {age: 20, description: '\n    Orc ... the name says it all.\n    ', hitPoints: 21, name: 'Ghog, Strangler of Pets'};
var $author$project$Characters$dazlyn = {age: 156, description: '\n    A shield dwarf prospector.\n    Business partner with Norbus Ironrune.\n    ', hitPoints: 4, name: 'Dazlyn Grayshard'};
var $author$project$Types$DeadEnd = {$: 'DeadEnd'};
var $author$project$Scenarios$DwarvenExcavation$discoveredPassageway = {adjoining: $author$project$Types$DeadEnd, characters: _List_Nil, description: '\n    On the left side of the entrance hallway, a secret door has been wedged open, but that passageway is soon blocked off with rubble.\n    ', name: 'Discovered Passageway'};
var $author$project$Scenarios$DwarvenExcavation$sacrificialChamber = {
	adjoining: $author$project$Types$Adjoining(_List_Nil),
...
var $author$project$Scenarios$DwarvenExcavation$entranceHallway = {
	adjoining: $author$project$Types$Adjoining(
		_List_fromArray(
			[$author$project$Scenarios$DwarvenExcavation$discoveredPassageway, $author$project$Scenarios$DwarvenExcavation$sacrificialChamber])),
	characters: _List_Nil,
	description: '\n    A dark hallway extends into the temple, wide enough for two people to walk abreast.\n    ',
	name: 'Entrance Hallway'
};
var $author$project$Characters$norbus = {age: 153, description: '\n    Business partner with Dazlyn Grayshard.\n    ', hitPoints: 4, name: 'Norbus Ironrune'};
var $author$project$Scenarios$DwarvenExcavation$templeEdifice = {
	adjoining: $author$project$Types$Adjoining(
		_List_fromArray(
			[$author$project$Scenarios$DwarvenExcavation$entranceHallway])),
	characters: _List_fromArray(
		[$author$project$Characters$dazlyn, $author$project$Characters$norbus]),
...
var $author$project$Scenarios$DwarvenExcavation$ruinedDwarvenSettlement = {
	adjoining: $author$project$Types$Adjoining(
		_List_fromArray(
			[$author$project$Scenarios$DwarvenExcavation$templeEdifice])),
	characters: _List_Nil,
...
var $author$project$Monsters$Orcs$zoll = {age: 11, description: '\n    Orc, bullied by his brothers.\n    ', hitPoints: 13, name: 'Zoll the Worthless'};
var $author$project$Scenarios$DwarvenExcavation$canyonEntrance = {
	adjoining: $author$project$Types$Adjoining(
		_List_fromArray(
			[$author$project$Scenarios$DwarvenExcavation$ruinedDwarvenSettlement])),
	characters: _List_fromArray(
		[$author$project$Monsters$Orcs$zoll, $author$project$Monsters$Orcs$ghog, $author$project$Monsters$Orcs$dhoman]),
...
var $author$project$Scenarios$DwarvenExcavation$dwarvenExcavation = {
...
var $author$project$Establishments$barthensProvisions = {
	...
	positions: _List_fromArray(
		[
			{character: $author$project$Characters$elmar, position: 'Proprieter'},
			{character: $author$project$Characters$ander, position: 'Clerk'},
...
var $author$project$Establishments$lionsShieldCoster = {
	...
	positions: _List_fromArray(
		[
			{character: $author$project$Characters$linene, position: 'Master of the trading post'}
		])
};
var $author$project$Characters$martha = {age: 50, description: '\n    Warm human who farms and makes cheese with milk from her cow, Delilah.\n    Married to John Boven.\n    ', hitPoints: 4, name: 'Martha Boven'};
var $author$project$Characters$halia = {age: 44, description: '\n    Guildmaster of the Miner\'s Exchange.\n    Calculating and cool.\n    She wears her short brown hair tied behind her head.\n    Seems to be glued to her desk and record book.\n    ---\n    Agent of the Zhentarim.\n    ', hitPoints: 4, name: 'Halia Thornton'};
var $author$project$Establishments$minersExchange = {
	...
	positions: _List_fromArray(
		[
			{character: $author$project$Characters$halia, position: 'Guildmaster'}
		])
};
var $author$project$Establishments$shrineOfLuck = {description: '\n    A shrine made of stones taken from the nearby ruins.\n    It is dedicated to Tymora, the goddess of luck and good fortune.\n    ', name: 'Shrine of Luck', positions: _List_Nil};
var $author$project$Characters$tablen = {age: 39, description: '\n    Short friendly human.\n    Gorgeous chestnut-brown, well-trimmed beard.\n    Speaks in a sing-songey voice.\n    Fastidious about cleanliness of the inn.\n    Wears an apron that is somehow always spotless.\n    Wanted to prospect, but decided he was better at hospitality.\n    From Triboar (East).\n    ', hitPoints: 4, name: 'Tablen Stonehill'};
var $author$project$Establishments$stonehillInn = {
	description: '\n    A modest, two-story roadhouse.\n    Six rooms upstairs.\n    New, shining floors.\n    5sp/night.\n    1sp/meal.\n    ',
	name: 'Stonehill Inn',
	positions: _List_fromArray(
		[
			{character: $author$project$Characters$tablen, position: 'Founder'},
			{character: $author$project$Characters$dazlyn, position: 'Customer'},
			{character: $author$project$Characters$norbus, position: 'Customer'}
		])
};
var $author$project$Establishments$townsmastersHall = {
...
var $author$project$View$hitPointsInput = function (max) {
	var maxString = $elm$core$String$fromInt(max);
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				...
				$elm$core$String$fromInt(max * (-1))),
				$elm$html$Html$Attributes$max(maxString),
				$elm$html$Html$Attributes$value(maxString)
			]),
		_List_Nil);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$View$hitPointsInput(hitPoints)
					]))
			]));
};
...
var $author$project$View$charactersDetails = F2(
	function (label, list) {
		return (!$elm$core$List$length(list)) ? $elm$html$Html$text('') : A2(
			$elm$html$Html$details,
			_List_fromArray(
				[
					...
					A2(
						...
						function (character_) {
							return A2(
								...
								_List_fromArray(
									[
										$author$project$View$character(character_)
									]));
						},
						list))
				]));
	});
var $author$project$View$adjoinings = function (adjoining) {
	if (adjoining.$ === 'DeadEnd') {
		return $elm$html$Html$text('');
	} else {
		var locations = adjoining.a;
		return A2(
			$elm$html$Html$ul,
			_List_fromArray(
				[
			...
			A2($elm$core$List$map, $author$project$View$location, locations));
	}
};
var $author$project$View$location = function (_v0) {
	var name = _v0.name;
	var description = _v0.description;
	var characters = _v0.characters;
	var adjoining = _v0.adjoining;
	return A2(
		$elm$html$Html$details,
		_List_fromArray(
			[
						...
						A2(
							...
							function (location_) {
								return A2(
									...
									_List_fromArray(
										[
											$author$project$View$location(location_)
										]));
							},
							locations))
					]))
...
var $author$project$View$establishment = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('establishment')
			]),
		_List_fromArray(
			[
				A2(
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(position.position)
												])),
											$author$project$View$character(position.character)
										]));
							},
							positions))
					]))
...
var $author$project$View$town = function (_v0) {
	var name = _v0.name;
	var description = _v0.description;
	var lore = _v0.lore;
	var residents = _v0.residents;
	var establishments = _v0.establishments;
	return A2(
		$elm$html$Html$details,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('town')
			]),
		_List_fromArray(
			[
				A2(
				...
				A2($author$project$View$charactersDetails, 'Residents', residents),
				A2(
				$elm$html$Html$details,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Establishments')
							])),
						A2(
						$elm$html$Html$ul,
						_List_Nil,
						A2(
							$elm$core$List$map,
							function (establishment_) {
								return A2(
									$elm$html$Html$li,
									_List_Nil,
									_List_fromArray(
										[
											$author$project$View$establishment(establishment_)
										]));
							},
							establishments))
					]))
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$section,
				_List_Nil,
				A2($elm$core$List$map, $author$project$View$town, model.towns)),
				A2(
				$elm$html$Html$section,
				_List_Nil,
				A2($elm$core$List$map, $author$project$View$scenario, model.scenarios))
			]));
};
